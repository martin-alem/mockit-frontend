  ...
  return (
    <Box>
      ...
      <Typography variant="caption" component="h3">
        Select the question that you want to tackle with your friend and the role that you want to have in the Mock Interview,
        and we'll generate a shareable link that your friend can use to join you for an interview.
      </Typography>
      <Box sx={{ mt: "20px" }}>
